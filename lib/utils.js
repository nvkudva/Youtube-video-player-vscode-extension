...
function isYtdlpMissing(err) {
  return !!(err && err.message && err.message.includes('yt-dlp not found'));
}
...
function getInstallCommand() {
  return process.platform === 'darwin'
    ...
    : process.platform === 'win32'
      ...
      : 'sudo apt install yt-dlp || sudo dnf install yt-dlp';
}

module.exports = { ytdlp, getStreamUrl, searchYoutube, formatDuration, isVideoId, isYouTubeUrl, isYtdlpMissing, getInstallCommand };
